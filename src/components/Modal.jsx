...
import { Icon, List, Button, Modal as ModalComponent, Transition } from 'semantic-ui-react';
          ...
          <Transition.Group duration={200}>
            {Object.keys(nominatedTitles).map((title) => (
              <List.Item key={nominatedTitles[title].imdbID}>
                ...
                <Button animated="vertical" onClick={() => handleClick(nominatedTitles[title].imdbID)}>
